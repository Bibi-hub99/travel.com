...
function SingleServicePage(props){
    ...
    return (
        <div>
            {isLoaded && <div className={`${props.singleServiceStyle} ${value.containerStyle} pt-10 relative`}>
                ...
                <div className={`flex justify-between`}>
                    ...
                    <NavLink className={checkState} to={'.'}>Information</NavLink>
                    <NavLink className={checkState} to={'comments'}>Comments</NavLink>
                    <NavLink className={checkState} to={'simalar-items'}>Similar items</NavLink>

                </div>
                <br></br>
                            
                <Outlet context={[singleService,setSingleService]}/>
            </div>}
        </div>
    )
